...
export const Sidebar = ({
  ...
  return (
    <div
      className={cn(
        "px-3 pt-2 h-full md:flex md:w-72 md:flex-col md:fixed md:inset-y-0 z-[80] bg-gray-900 text-white",
      ...
      <div>
        {routes.map((route) => {
          return (
            <div
              className={cn(
                "cursor-pointer hover:bg-gray-700 rounded-md py-2 px-2 font-light",
